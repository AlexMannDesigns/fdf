...
SRC_FILES = projection_control.c draw_wireframe.c fdf_control.c plot_line.c key_events.c colours.c coords.c utils.c main.c resize_event.c draw_background.c draw_utils.c map_parser.c
